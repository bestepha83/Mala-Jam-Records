...
import {
  FaFacebookSquare, FaInstagram, FaSpotify, FaYoutubeSquare, FaSoundcloud
} from 'react-icons/fa';
  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        />
        <article
          className={`artist-content ${artist.frontmatter.thumbnail || `no-image`}`}
        >
          ...
          {artist.frontmatter.description && (
            <p class="artist-content-excerpt">"{artist.frontmatter.description}"</p>
          )}
          ...
          <SimilarArticlesComponent releases={artist.frontmatter.releases} tags={artist.frontmatter.tags} currentArticleSlug={artist.frontmatter.slug}/>
        </article>
      </Layout>
    )
  }
