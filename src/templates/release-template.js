  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        />
        <article
          className={`${release.frontmatter.thumbnail || `no-image`}`}
        >
          <div className = "release-content">
            ...
            <div>
              {release.frontmatter.description && (
                <p className="release-content-excerpt">"{release.frontmatter.description}"</p>
              )}
            </div> 
            <div className = "release-links">
              <a href={release.frontmatter.links} className="button large primary">
                Listen Now
              </a> 
              <CalculateArtist tags={release.frontmatter.tags} currentArticleSlug={release.frontmatter.slug}/>
            </div> 
            <div
